 ...
 * @author adrianromero
 */
public abstract class JRetailPanelEditTicket extends JPanel implements JPanelView, BeanFactoryApp, RetailTicketsEditor {
    ...
    protected JRetailPanelEditButtons m_jbtnconfig;
         ...
         Action doNonChargablePrint = new AbstractAction() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Logger.getLogger(JRetailPanelEditTicket.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        };
   ...
   class TextListener implements FocusListener
    ...
    public void init(AppView app) throws BeanFactoryException {
     ...
     //   m_oTicket.setSplitValue("");
        ...
        m_jbtnconfig = new JRetailPanelEditButtons("Ticket.Buttons", this);
...
if(ticket.getTaxes().size()!=0){
    ...
    public void visorTicketLine(RetailTicketLineInfo oLine){
        if (oLine == null) { 
            ...
            try {
                ...
                msg.show(JRetailPanelEditTicket.this);
    ...
    private void showMessage(JRetailPanelEditTicket aThis, String msg) {
    ...
    public class ScriptObject {
        ...
        public double getInputValue() {
            if (m_iNumberStatusInput == NUMBERVALID && m_iNumberStatusPor == NUMBERZERO) {
                return JRetailPanelEditTicket.this.getInputValue();
            } else {
                return 0.0;
            }
        }
        ...
        public void printReport(String resourcefile) {
            JRetailPanelEditTicket.this.printReport(resourcefile, ticket, ticketext);
        }
       
        
        public void printTicket(String sresourcename) {
            JRetailPanelEditTicket.this.printTicket(sresourcename, ticket, ticketext);
        }              
                    ...
                    .add(m_jPanTotals1Layout.createSequentialGroup()
                        .add(m_jPanTotals1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                            .add(m_jPanTotals1Layout.createSequentialGroup()
                                ...
                                .add(5, 5, 5)
                                .add(m_jtxtChequeNo, 0, 113, Short.MAX_VALUE))
                        ...
                        .add(m_jPanTotals1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            ...
                            .add(m_jCreditAmount, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE))))
                .addContainerGap(14, Short.MAX_VALUE))
            .add(jPanel11, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 713, Short.MAX_VALUE)
        );
    ...
    private void m_jBtnDiscountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jBtnDiscountActionPerformed
        ...
        try {
            ...
            if ("Admin".equalsIgnoreCase(role) || "Manager".equalsIgnoreCase(role)) {// for admin
                ...
                JRateEditor.showMessage(JRetailPanelEditTicket.this, dlReceipts, m_oTicket, role,type);
            } else if ((role.equalsIgnoreCase("Cashier")) || (role.equalsIgnoreCase("Syscashier")) ) {//cashier
                JDiscountAssign.showMessage(JRetailPanelEditTicket.this, dlCustomers, m_App, m_oTicket);
            } else {
