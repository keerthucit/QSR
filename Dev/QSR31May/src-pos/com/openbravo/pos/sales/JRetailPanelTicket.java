...
//          m_jPanTotals1.setVisible(false);
        ...
        if (m_oTicket != null) {
            ...
            try {
              ...
              System.out.println("m_oTicket.getOldTableName()--"+m_oTicket.getOldTableName());
...
//            }
    ...
    private void addTicketLine(ProductInfoExt oProduct, double dMul, double dPrice) {   
        ...
        System.out.println("charge value in addticket"+oProduct.getServiceChargeID()+m_oTicket.getCustomer()+"---"+oProduct.getSwachBharatTaxId());
        ...
        addTicketLine(new RetailTicketLineInfo(oProduct, dMul, dPrice, promoRuleIdList,dlSales,m_oTicket,m_ticketlines,this,tax, 0,oProduct.getName(),oProduct.getProductType(),oProduct.getProductionAreaType(),(java.util.Properties) (oProduct.getProperties().clone()),addonId,0,null,0,null,null,null,charge,sertax,oProduct.getParentCatId(),oProduct.getPreparationTime(),null,sbTax));
    ...
    private String getSpaces(int len) {
      ...
      private java.util.List<TicketLineConstructor> getAllLines(RetailTicketInfo ticket, Object ticketext) {
       ...
       allLines.add(new TicketLineConstructor(m_App.getProperties().getProperty("machine.address2")));
        ...
        allLines.add(new TicketLineConstructor("Tbl: " + ticketext + getSpaces(2) + "Chk:" + getSpaces(1) + ticket.getDocumentNo()+ getSpaces(4) +"Gst:" + getSpaces(1) + ticket.getNoOfCovers()));
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        jTaxPanel.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 100, 23));

        m_jServiceTax.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jTaxPanel.add(m_jServiceTax, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 70, 70, 23));
        ...
        jTaxPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 127, 200, 50));

        jLabel9.setText("SWACHH BHARAT TAX");
        jTaxPanel.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 130, 20));

        m_jSwachBharat.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jTaxPanel.add(m_jSwachBharat, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 70, 20));

        jLabel13.setText("SERVICE CHARGE");
        jTaxPanel.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 120, 23));
        ...
        jTaxPanel.add(m_jServiceCharge, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, 80, 23));
             ...
             if(uniqueProductionAreas.size()!=0){
              ...
              try {
                  if(storeLocation.equals("BlrIndranagar") || storeLocation.equals("BlrKoramangala") || storeLocation.equals("Chennai")){
                   ...
                   // printer.print(allLines,printerInfo.get(j).getPath());
               //   kotprintIssue=0;printerInfo.get(j).getPath()
...
//                            calculateServiceCharge();
   ...
   if(splitfunction==1){
       ...
       // ticket1.setOldTableName(m_oTicket.getOldTableName());
       ...
       if(!m_oTicket.isPrinted()){//CASE 1: determine is it first print for this table
           ...
           closeInvoiceTicket(m_oTicket); //insert into invoice && invoicelines
            ...
            //    dlSales.disableInvoiceTickets(m_oTicket.getTicketId()); //update existing record with inactive status
               JRetailSecondprintReason.showMessage(this, dlSales, m_oTicket.getTicketId(), "sales");
