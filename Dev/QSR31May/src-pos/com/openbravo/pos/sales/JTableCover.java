...
public class JTableCover extends JDialog {
    ...
    public static void showMessage(Component parent, DataLogicReceipts dlReceipts, RetailTicketInfo tinfo, Place place, RetailTicketsEditor m_panelticket,JRetailTicketsBagRestaurantMap restaurantMap,boolean isNew) {
     ...
     String input=m_jCovers.getText();
       ...
       }else if(pattern.matcher(input).matches())
      {
       ...
       if(restaurantMap.getStatus()==true){
        ...
        try {
            localDlReceipts.insertTableCovers(UUID.randomUUID().toString(), place.getId(), Integer.parseInt(m_jCovers.getText()));
        } catch (BasicException ex) {
            Logger.getLogger(JTableCover.class.getName()).log(Level.SEVERE, null, ex);
        }
        }else{
            localDlReceipts.updateNoOfCovers(place.getId(), Integer.parseInt(m_jCovers.getText()));
//              int noOfCovers = 0;
//            try {
//                noOfCovers = localDlReceipts.getTableCovers(place.getId());
//            } catch (BasicException ex) {
//                Logger.getLogger(JTableCover.class.getName()).log(Level.SEVERE, null, ex);
//            }
             int noOfCovers=Integer.parseInt(m_jCovers.getText());
              restaurantMap.setNoOfCovers(noOfCovers);
