...
public class JRetailTicketCancel extends JRetailTicketsBag {
    ...
    private JRetailTicketsCancelDisplay m_TicketsBagTicketBag;
    private JRetailTicketCancelEdit m_panelticketedit;
     ...
     */
    public JRetailTicketCancel(AppView app, JRetailTicketCancelEdit panelticket) {
        ...
        m_TicketsBagTicketBag = new JRetailTicketsCancelDisplay(this);
...
//        m_jTicketEditor.reset();
        ...
        try {
            ...
            Logger.getLogger(JRetailTicketCancel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void resetToTicket() {
        printTicket();
//        m_jTicprintTicketketEditor.reset();
        //       m_jTicketEditor.activate();
        m_panelticketedit.setRetailActiveTicket(null, null);
    }
    ...
    private void showMessage(JRetailTicketCancel aThis, String msg, Color colour) {
...
//                : m_dlSales.loadRetailTicket(iTickettype, iTicketid) ;
            ...
            if (ticket == null) {
                ...
                try {
                    taxeslogic.calculateTakeAwayTaxes(m_ticket);
...
//        m_jTicketEditor.reset();
    ...
    private void printTicket() {
        m_jPanelTicket.setVisible(true);
        jButtonCancel.setEnabled(true);
        m_jPrint.setEnabled(m_ticket != null);
        System.out.println("Inside Print Ticket");
        // Este deviceticket solo tiene una impresora, la de pantalla
...
//        jrbSales = new javax.swing.JRadioButton();
        ...
        // jButtonCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/search.png"))); // NOI18N
        jButtonCancel.setText(AppLocal.getIntString("label.cancelbill")); // NOI18N
        ...
        m_jButtons.add(jButtonCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 12, 100, 35));
    ...
    private void m_jPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jPrintActionPerformed
        if (m_ticket != null) {
            ...
            if (JRetailReprintReason.status) {
                try {
                    String sresourcename = "Printer.Bill";
    ...
    private void jButtonCancelActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            if (res == JOptionPane.YES_OPTION) {
               m_dlSales.deleteCancelTicket(id);
...
//        System.out.println("CANCEL" + m_ticket.getTicketId());
//        System.out.println("CANCEL ID" + m_ticket.getId());
