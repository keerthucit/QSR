...
//            m_jTxtTable.setFocusable(false);
     ...
     * initialize the form.
     * WARNING: Do NOT modify this ctode. The content of this method is
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(750, 45));
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(5, 5, 5)
                .add(m_jBtnCover, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 128, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(5, 5, 5)
   ...
   public static void clickCancel(){
    ...
    private void m_jBtnCoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jBtnCoverActionPerformed
           ...
           //setTableName(m_restaurant.getTableId()); 
           setCovers(m_restaurant.getTableId()); 
        
    }//GEN-LAST:event_m_jBtnCoverActionPerformed
  public void setCovers(String tableId){
       m_jBtnCover.setText("Covers("+m_restaurant.getNoOfCovers()+")");
    }
...
public static void setHoldTicket(RetailTicketInfo  ticket){
     m_restaurant.newHoldTicket(ticket);
     m_restaurant.loadTickets();
     m_restaurant.startTimer();
}
