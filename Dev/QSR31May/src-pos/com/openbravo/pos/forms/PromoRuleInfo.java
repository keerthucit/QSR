...
public class PromoRuleInfo implements SerializableRead, SerializableWrite, Serializable  {
 ...
 public void readValues(DataRead dr) throws BasicException {
   ...
   public String getIsSku(){
     ...
     * @return the mainBogo
     */
    public String getMainBogo() {
        return mainBogo;
    }

    /**
     * @param mainBogo the mainBogo to set
     */
    public void setMainBogo(String mainBogo) {
        this.mainBogo = mainBogo;
    }
