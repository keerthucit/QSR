...
import com.sysfore.pos.cashmanagement.PettyCashEditor;
...
//    private javax.swing.JScrollPane m_jPanelLeft=new  javax.swing.JScrollPane();
    ...
    public JPrincipalApp(JRootApp appview, AppUser appuser) {
        ...
        m_dlSystem = (DataLogicSystem) m_appview.getBean("com.openbravo.pos.forms.DataLogicSystem");
         ...
         dlCustomers = (DataLogicCustomers) m_appview.getBean("com.openbravo.pos.customers.DataLogicCustomers");
        ...
        initComponents();
           String user = m_appuser.getName();
           String role = null;
        try {
            role = dlCustomers.getRolebyName(user);
        } catch (BasicException ex) {
            Logger.getLogger(JPrincipalApp.class.getName()).log(Level.SEVERE, null, ex);
        }

         if(role.equals("Steward")||role.equals("Bartender")){
...
//             jPanel2.setVisible(false);
//             jPanel1.setVisible(false);
//             jPanel2.remove(Box.createVerticalStrut(50));
//        }
      //  jPanel2.add(Box.createVerticalStrut(50), 0);
...
//        m_principalnotificator.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("TextField.shadow")), javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 5)));        
    ...
    public JPrincipalApp(PettyCashEditor aThis, AppUser user) {
...
//        public JTaskPaneGroup getTaskGroup() {
    ...
    public void getAction(){
          new ExitAction("/com/openbravo/images/gohome.png", "Menu.Exit");
    }
      public JXTaskPane taskGroup;
