...
CREATE TABLE CATEGORIES (
    ...
    IMAGE MEDIUMBLOB,
    ISDISCOUNTAPPLICABLE varchar(1) NOT NULL DEFAULT 'N',
...
DOCTAXAMOUNT varchar(60) NOT NULL DEFAULT 'D',
   ...
   ISSERVICECHARGE VARCHAR(1) NOT NULL DEFAULT 'N',
    ...
    ISSWACHBHARATTAX VARCHAR(1) NOT NULL DEFAULT 'N',
...
DOCSERVICECHARGEAMOUNT varchar(60) NOT NULL DEFAULT 'D',
 PRIMARY KEY (ID),
CONSTRAINT servicecharge_chargebase FOREIGN KEY (SERVICECHARGEBASEID)  REFERENCES SERVICECHARGE (ID),
...
CREATE TABLE PRODUCTS (
    ...
    SWACHBHARATTAX VARCHAR(255) DEFAULT NULL,
    SEQUENCE INT(4),
    PRIMARY KEY (ID),
    ...
    CONSTRAINT PRODUCTS_FK_SC FOREIGN KEY(SERVICECHARGE) REFERENCES SERVICECHARGE(ID),
    CONSTRAINT PRODUCTS_FK_ST FOREIGN KEY(SERVICETAX) REFERENCES TAXCATEGORIES(ID),
    CONSTRAINT PRODUCTS_FK_SB FOREIGN KEY(SWACHBHARATTAX) REFERENCES TAXCATEGORIES(ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE TICKETS (
    ...
    TICKETTYPE INT(11) DEFAULT 0 NOT NULL,
    ...
    CUSTOMERDISCOUNT DOUBLE(10,2) NOT NULL DEFAULT '0',
    DISCOUNTRATE VARCHAR(6) NOT NULL DEFAULT '0',
    ISHOMEDELIVERY VARCHAR(1) DEFAULT NULL,
    DELIVERYBOY VARCHAR(255) DEFAULT NULL,
    ADVANCEISSUED DOUBLE(10,0) NOT NULL DEFAULT '0',
    ISCOD VARCHAR(1) DEFAULT NULL,
    DELIVEREDTO VARCHAR(60) DEFAULT NULL,
    ADVANCERETURNED DOUBLE(6,0) NOT NULL DEFAULT '0',
    ...
    SERVICETAXAMT DOUBLE(10,2) NOT NULL DEFAULT '0',
    SERVICECHARGEID VARCHAR(255) DEFAULT NULL,
    SERVICECHARGEAMT DOUBLE(10,2) NOT NULL DEFAULT '0',
    ISTAKEAWAY VARCHAR(1) NOT NULL DEFAULT 'N',
    ...
    SOSORDERID varchar(255) DEFAULT NULL,
    SWACHBHARATTAXAMT DOUBLE(10,2) NOT NULL DEFAULT '0',
    PRIMARY KEY (ID),
...
CREATE TABLE TICKETLINES (
    ...
    SERVICECHARGEID varchar(255) DEFAULT NULL,
    SERVICETAXID varchar(255) DEFAULT NULL,
    SOSORDERLINEID varchar(255) DEFAULT NULL,
    SWACHBHARATTAXID  VARCHAR(255) DEFAULT NULL,
    ...
    CONSTRAINT TICKETLINES_FK_SC FOREIGN KEY (SERVICECHARGEID) REFERENCES SERVICECHARGE (ID),
    CONSTRAINT TICKETLINES_FK_ST FOREIGN KEY (SERVICETAXID) REFERENCES TAXES (ID),
 CONSTRAINT TICKETLINES_ibfk_3 FOREIGN KEY (SWACHBHARATTAXID) REFERENCES TAXES (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE SERVICECHARGELINES (
  ID varchar(255) NOT NULL,
  RECEIPT varchar(255) NOT NULL,
  SERVICECHARGEID varchar(255) NOT NULL,
  BASE double NOT NULL,
  AMOUNT double NOT NULL,
  PRIMARY KEY (ID),
  KEY SERVICECHARGE_ID (SERVICECHARGEID),
  KEY CHARGESLINES_RECEIPT (RECEIPT),
  CONSTRAINT CHARGESLINES_RECEIPT FOREIGN KEY (RECEIPT) REFERENCES receipts (ID),
  CONSTRAINT SERVICECHARGE_ID FOREIGN KEY (SERVICECHARGEID) REFERENCES SERVICECHARGE (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE INVOICE (
 ...
 BILLDISCOUNT double(6,1) NOT NULL,
 LEASTVALUEDISCOUNT double(6,1) NOT NULL,
 CUSTOMERDISCOUNT double(10,2) NOT NULL DEFAULT '0.00',
 DISCOUNTRATE varchar(6) NOT NULL DEFAULT '0',
 ISHOMEDELIVERY varchar(1) DEFAULT NULL,
 DELIVERYBOY varchar(255) DEFAULT NULL,
 ADVANCEISSUED double(10,0) NOT NULL DEFAULT '0',
 ISCOD varchar(1) DEFAULT NULL,
 DELIVEREDTO varchar(60) DEFAULT NULL,
 ADVANCERETURNED double(6,2) NOT NULL DEFAULT '0.00',
 COLLECTEDAMOUNT double(6,2) NOT NULL DEFAULT '0.00',
 DELIVERYSTATUS varchar(1) NOT NULL DEFAULT 'N',
 COMPLETED varchar(1) NOT NULL DEFAULT 'N',
 BILLAMOUNT double(10,2) NOT NULL DEFAULT '0.00',
 DELIVEREDDATE datetime DEFAULT NULL,
 ...
 TABLEID varchar(255) DEFAULT NULL,
 SERVICETAXID varchar(255) DEFAULT NULL,
 SERVICETAXAMT double(10,2) NOT NULL DEFAULT '0.00',
 SERVICECHARGEID varchar(255) DEFAULT NULL,
 SERVICECHARGEAMT double(10,2) NOT NULL DEFAULT '0.00',
 ISTAKEAWAY varchar(1) NOT NULL DEFAULT 'N',
 ISNONCHARGABLE varchar(1) NOT NULL DEFAULT 'N',
 NOOFCOVERS int(10) NOT NULL DEFAULT '0',
 HDCUSTOMERADDRESS varchar(255) DEFAULT NULL,
 ROUNDOFFVALUE double(6,2) DEFAULT '0.00',
 ISCANCELTICKET varchar(1) NOT NULL DEFAULT 'N',
 CANCELREASONID varchar(255) DEFAULT NULL,
 CANCELCOMMENTS varchar(255) DEFAULT NULL,
 PARENTBILLNO varchar(50) DEFAULT NULL,
 ...
 SWACHBHARATTAXAMT DOUBLE(10,2) NOT NULL DEFAULT '0',
  ...
  KEY HISTICKETS_TICKETID (TICKETTYPE,TICKETID),
  KEY DISCOUNT_REASON_ID (DISCOUNTREASONID),
  KEY TICKETS_TABLE_ID (TABLEID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE INVOICELINES (
  ...
  DISCOUNT double(6,0) NOT NULL,
  PRICE double NOT NULL,
  DISCOUNTPRICE double(10,2) NOT NULL DEFAULT '0.00',
  TAXID varchar(255) NOT NULL,
  ATTRIBUTES mediumblob,
  PROMOTIONCAMPAIGNID varchar(255) DEFAULT NULL,
  KOTID int(20) NOT NULL,
...
SWACHBHARATTAXID  VARCHAR(255) DEFAULT NULL,
  ...
  KEY SERVICECHARGEID (SERVICECHARGEID),
  KEY SERVICETAXID (SERVICETAXID),
  CONSTRAINT INVOICELINES_FK_TICKET FOREIGN KEY (TICKET) REFERENCES invoice (ID),
  CONSTRAINT invoicelines_ibfk_1 FOREIGN KEY (SERVICECHARGEID) REFERENCES servicecharge (ID),
  CONSTRAINT invoicelines_ibfk_2 FOREIGN KEY (SERVICETAXID) REFERENCES taxes (ID),
 CONSTRAINT invoicelines_ibfk_3 FOREIGN KEY (SWACHBHARATTAXID) REFERENCES taxes (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE POSACTIONSACCESS( 
	...
	MOVETABLEACCESS VARCHAR(1) DEFAULT 'N',
        BILLONHOLDACCESS VARCHAR(1) DEFAULT 'N'
	)ENGINE=INNODB DEFAULT CHARSET=utf8;
...
CREATE TABLE BILLONHOLDTICKETS (
  ID varchar(255) NOT NULL,
  TABLEID varchar(255) DEFAULT NULL,
  CONTENT mediumblob,
  TICKETID int(11) NOT NULL,
  BILLAMOUNT double(10,2) DEFAULT '0',
  PERSON varchar(255) NOT NULL,
  DATENEW datetime NOT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT BILLONHOLDTICKETS_TABLE_ID FOREIGN KEY (TABLEID) REFERENCES PLACES (ID),
  CONSTRAINT BILLONHOLDTICKETS_PERSON_ID FOREIGN KEY (PERSON) REFERENCES PEOPLE (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE ACTIONSLOG (
  ...
  REASON VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY  (ID),
  CONSTRAINT ACTIONSLOG_FK_1 FOREIGN KEY (USER) REFERENCES PEOPLE (ID),
  CONSTRAINT ACTIONSLOG_STABLE_ID FOREIGN KEY (SOURCETABLE) REFERENCES PLACES (ID),
  CONSTRAINT ACTIONSLOG_DTABLE_ID FOREIGN KEY (DESTINATIONTABLE) REFERENCES PLACES (ID)	
) ENGINE=InnoDB DEFAULT CHARSET=utf8;