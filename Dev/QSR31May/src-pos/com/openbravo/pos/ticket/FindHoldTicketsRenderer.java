 ...
 */
public class FindHoldTicketsRenderer extends DefaultListCellRenderer {
    ...
    public FindHoldTicketsRenderer() {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        //int ticketType = ((FindHoldTicketsInfo)value).getTicketType();
