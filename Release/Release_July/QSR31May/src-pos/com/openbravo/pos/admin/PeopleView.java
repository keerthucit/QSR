...
public class PeopleView extends JPanel implements EditorRecord {
    ...
    public PeopleView(DataLogicAdmin dlAdmin, DirtyManager dirty) {
        ...
        m_jDelivery.addActionListener(dirty);
        writeValueEOF();
    }
    ...
    public void writeValueDelete(Object value) {
        ...
        m_jDelivery.setSelected(((Boolean) people[7]).booleanValue());
        m_jName.setEnabled(false);
        m_jRole.setEnabled(false);
        m_jVisible.setEnabled(false);
        m_jDelivery.setEnabled(false);
    ...
    public void writeValueEdit(Object value) {
        ...
        jcard.setText(Formats.STRING.formatValue(people[5]));
        m_jImage.setImage((BufferedImage) people[6]);
        if((people[7].toString()).equals("Y")){
             m_jDelivery.setSelected(true);
        }else{
              m_jDelivery.setSelected(false);
        }
      //  m_jDelivery.setSelected(((Boolean) people[7]).booleanValue());
        m_jName.setEnabled(true);
        m_jRole.setEnabled(true);
    ...
    public Object createValue() throws BasicException {
        ...
        people[7] = Formats.STRING.parseValue(deliveryBoy);
        return people;
    }    
    ...
    private void initComponents() {
        ...
        m_jDelivery = new javax.swing.JCheckBox();
    ...
    private javax.swing.JCheckBox m_jDelivery;
