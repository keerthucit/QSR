...
public class JRetailResettleBillDisplay extends javax.swing.JPanel {
    
    private JRetailHoldTicket m_ticketsbagticket;

    /** Creates new form JTicketsBagTicketBag */
    public JRetailResettleBillDisplay(JRetailHoldTicket ticketsbagticket) {
        m_ticketsbagticket = ticketsbagticket;
        initComponents();
    }

    
    public JRetailResettleBillDisplay() {
        initComponents();
    }
