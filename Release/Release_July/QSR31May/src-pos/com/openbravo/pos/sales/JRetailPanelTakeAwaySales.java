...
public class JRetailPanelTakeAwaySales extends JRetailPanelTakeAway {

    private CatalogSelector m_cat;
   
    /** Creates a new instance of JPanelTicketSales */
    public JRetailPanelTakeAwaySales() {
    }
    ...
    protected Component getSouthComponent() {
        m_cat = new JRetailCatalog(dlSales,
    ...
    protected void resetSouthComponent(String value) {
        m_cat.showRetailCatalogPanel(value);
    }
    
    protected JRetailTicketsBag getJTicketsBag() {
        return JRetailTicketsBag.createTicketsBag(m_App.getProperties().getProperty("machine.ticketsbag"), m_App, this,"TakeAway");
    }
    
    @Override
    public void activate(){
     //   super.setHomeDeliverySale("Sales");
       
        super.activate();
        //  super.setEditSale("Sales");
        m_cat.loadCatalog();
    }
