...
public class JDiscountAssign extends JDialog {
    ...
    public static boolean showMessage(Component parent, DataLogicCustomers dlCustomers, AppView m_App, RetailTicketInfo tinfo) throws BasicException {
        tinfoLocal = tinfo;
        parentLocal = parent;
        m_dlSystem = (DataLogicSystem) m_App.getBean("com.openbravo.pos.forms.DataLogicSystem");
        dlReceipts = (DataLogicReceipts) m_App.getBean("com.openbravo.pos.sales.DataLogicReceipts");
        dlCustomers = (DataLogicCustomers) m_App.getBean("com.openbravo.pos.customers.DataLogicCustomers");
        return showMessage(parent, dlCustomers);
    }

    private static boolean showMessage(Component parent, DataLogicCustomers dlCustomers) {
        ...
        return myMsg.init(dlCustomers);

    }

    public boolean init(DataLogicCustomers dlCustomers) {
    ...
    public boolean doLogin(String user, String passw) throws BasicException {
         login = false;
