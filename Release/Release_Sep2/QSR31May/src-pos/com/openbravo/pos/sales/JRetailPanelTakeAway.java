    ...
    private void m_jDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jDeleteActionPerformed
        ...
        if (i < 0) {
            ...
            if (kotStatus != 0) {
                ...
                try {
                    if (m_oTicket.getLine(0).getPromoType().equals("SIBG") && leastValuePromo == true) {
    ...
    public void settleBill() {
        ...
        if (m_oTicket.getLinesCount() != 0) {
            try {
                ...
                settlementSucess = JPaymentEditor.showMessage(JRetailPanelTakeAway.this, dlReceipts, m_oTicket, this, "TakeAway");
                //  if(m_oTicket.getParentId()==null)  {
                System.out.println("printerissue" + kotprintIssue);
