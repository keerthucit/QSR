...
//    public boolean updateMode = false;
 ...
 //   public static String userRole = null;
  ...
  //  private boolean enablity;
    ...
    public static void showMessage(Component parent, DataLogicReceipts dlReceipts, RetailTicketInfo tinfo, String product, int tindex,String Status) {
...
//            }
            ...
            if(deleteStatus.equals("lineDelete")){
             ...
             localDlReceipts.insertCancelledKot(tinfoLocal.getId(),tinfoLocal.getDate(),tinfoLocal.getTicketId(),productName, "Y",qty,kotTicket,"Y",reason,reasonId,tinfoLocal.getPlaceId(),tinfoLocal.getUser().getId());
             if(addonId!=null) {
                  ...
                  if(i!=index){
                   if(tinfoLocal.getLine(i).getIsKot()==1)   {
                    if(addonId.equals(tinfoLocal.getLine(i).getAddonId()) && primaryAddon==1){
                        localDlReceipts.insertCancelledKot(tinfoLocal.getId(),tinfoLocal.getDate(),tinfoLocal.getTicketId(),tinfoLocal.getLine(i).getProductID(), "Y",1*tinfoLocal.getLine(i).getMultiply(),kotTicket,"Y","Addon Item Cancelled KOT",reasonId,tinfoLocal.getPlaceId(),tinfoLocal.getUser().getId());
                     }
                  }
                  } 
               }
               ...
               qty=1; 
                ...
                for(int i=0;i<tinfoLocal.getLinesCount();i++){
                  if(i!=index){
                   if(tinfoLocal.getLine(i).getIsKot()==1)   {   
                    if(addonId.equals(tinfoLocal.getLine(i).getAddonId()) && primaryAddon==1){
                        localDlReceipts.insertCancelledKot(tinfoLocal.getId(),tinfoLocal.getDate(),tinfoLocal.getTicketId(),tinfoLocal.getLine(i).getProductID(), "Y",qty,kotTicket,"Y","Addon Item Cancelled KOT",reasonId,tinfoLocal.getPlaceId(),tinfoLocal.getUser().getId());
                      }
                   }
                  }  
               }
