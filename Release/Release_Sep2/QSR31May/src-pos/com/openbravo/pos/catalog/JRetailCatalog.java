...
//        }
        ...
        for (CategoryInfo prod : categories) {
            jCategoryTab.addButton(new ImageIcon(tnbcat.getThumbNailText(prod.getImage(), getCategoryLabel(prod))), new SelectedCategory(prod));
        }
...
//        }
        ...
        try {
            defaultCategory = m_dlSales.getDefaultCategory();
        } catch (BasicException ex) {
            Logger.getLogger(JRetailCatalog.class.getName()).log(Level.SEVERE, null, ex);
        }
      ...
      //       m_productsset.clear();
        ...
        try {
              if(menuStatus.equals("false")){
            products = m_dlSales.getProductCatalog(defaultCategory);
              }else{
                   day = getWeekDay();
                  currentMenuList = m_dlSales.getMenuId(day);
                if (currentMenuList.size() != 0) {
                  ...
                  products = m_dlSales.getMenuProductCatalog(defaultCategory,menuId);
              }
         ...
         jcurrTab.applyComponentOrientation(getComponentOrientation());
          m_jProducts.add(jcurrTab, "PRODUCT." + defaultCategory);
         ...
         for (ProductInfoExt prod : products) {
          ...
          CardLayout cl = (CardLayout)(m_jProducts.getLayout());
           cl.show(m_jProducts, "PRODUCT." + defaultCategory);
          //  showProductPanel(defaultCategory);
...
//
//                    jSubCategoryTab.addButton(new ImageIcon(tnbSubcat.getThumbNailText(cat.getImage(), cat.getName())), new SelectedSubCategory(cat));
//                }
...
//        showingcategory = null;
    ...
    private void showSubcategoryPanel(CategoryInfo category) {
      System.out.println("showSubcategoryPanel"); 
...
//            m_jsubCategories.setVisible(false);
    ...
    private void initComponents() {
        ...
        m_jProducts.setBackground(new java.awt.Color(235, 222, 208));
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(m_jCategories, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 129, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(m_jProducts, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 288, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
