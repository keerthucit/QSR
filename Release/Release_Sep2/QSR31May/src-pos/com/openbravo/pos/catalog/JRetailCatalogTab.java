 ...
 * @author adrianromero
 */
public class JRetailCatalogTab extends javax.swing.JPanel {
    
    private JFlowPanel flowpanel;
    
    /** Creates new form JCategoryProducts */
    public JRetailCatalogTab() {
        initComponents();

        flowpanel = new JFlowPanel();
      //  flowpanel.setBackground(new java.awt.Color(154, 205, 50));
    ...
    public void addButton(Icon ico, ActionListener al) {
        ...
        btn.setPreferredSize(new java.awt.Dimension(110, 57));
        btn.addActionListener(al);
        flowpanel.add(btn);        
    }
    
    public void addPopularItemButton(Icon ico, ActionListener al) {
        JButton btn = new JButton();
        btn.applyComponentOrientation(getComponentOrientation());
        btn.setIcon(ico);
        btn.setFocusPainted(false);
