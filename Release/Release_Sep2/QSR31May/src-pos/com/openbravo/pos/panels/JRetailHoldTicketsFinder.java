...
import com.openbravo.pos.ticket.FindHoldTicketsRenderer;
 ...
 */
public class JRetailHoldTicketsFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private FindHoldTicketsInfo selectedTicket;
   
    /** Creates new form JCustomerFinder */
    private JRetailHoldTicketsFinder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }

    /** Creates new form JCustomerFinder */
    private JRetailHoldTicketsFinder(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }
    
    public static JRetailHoldTicketsFinder getHoldTickets(Component parent, DataLogicSales dlSales, DataLogicCustomers dlCustomers) {
        Window window = getWindow(parent);
        
        JRetailHoldTicketsFinder myMsg;
        if (window instanceof Frame) { 
            myMsg = new JRetailHoldTicketsFinder((Frame) window, true);
        } else {
            myMsg = new JRetailHoldTicketsFinder((Dialog) window, true);
        }
    ...
    public FindHoldTicketsInfo getSelectedTicket() {
    ...
    private void init(DataLogicSales dlSales, DataLogicCustomers dlCustomers) {
        ...
        lpr = new ListProviderCreator(dlSales.getHoldTicketsList(), this);

        jListTickets.setCellRenderer(new FindHoldTicketsRenderer());
    ...
    public Object createValue() throws BasicException {
        ...
        // Receipt money
        afilter[3] = jtxtMoney.getDoubleValue();
        afilter[2] = afilter[5] == null ? QBFCompareEnum.COMP_NONE : jcboMoney.getSelectedItem();
        ...
        afilter[4] = (startdate == null) ? QBFCompareEnum.COMP_NONE : QBFCompareEnum.COMP_GREATEROREQUALS;
        afilter[5] = startdate;
        afilter[6] = (enddate == null) ? QBFCompareEnum.COMP_NONE : QBFCompareEnum.COMP_LESS;
        afilter[7] = enddate;
    ...
    private void jcmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcmdOKActionPerformed
        selectedTicket = (FindHoldTicketsInfo) jListTickets.getSelectedValue();
         dispose();
