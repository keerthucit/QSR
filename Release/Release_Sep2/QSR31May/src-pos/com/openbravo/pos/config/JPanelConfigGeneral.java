...
import com.openbravo.theme.skin.LunaLookAndFeel;
...
public class JPanelConfigGeneral extends javax.swing.JPanel implements PanelConfig {
    ...
    jcboSystemType.setVisible(false);
    String[] printernames = ReportUtils.getPrintNames();
    jTxtPosNo.getDocument().addDocumentListener(dirty);
    jcboStoreName.addActionListener(dirty);
    jTxtvalidity.getDocument().addDocumentListener(dirty);
        ...
        jcboSystemType.addActionListener(dirty);
        ...
        m_jtxtJPOSDrawer.getDocument().addDocumentListener(dirty);
         jchkTallyExport.addActionListener(dirty);
...
//        jcboLAF.addItem(new UIManager.LookAndFeelInfo("Openbravo", "com.openbravo.pos.skin.OpenbravoLookAndFeel"));
      ...
      jcboLAF.addItem(new LAFInfo("POSXPRS", "com.openbravo.theme.skin.LunaLookAndFeel"));
        ...
        jcboSystemType.addItem("keyboard");
        jcboSystemType.addItem("touchscreen");
        jcboTicketsBag.addItem("simple");
        jcboTicketsBag.addItem("standard");
        jcboTicketsBag.addItem("restaurant");
        //Tax calculation happens based on this parameters 
        jcboStoreName.addItem("Toit");
         jcboStoreName.addItem("Habanero");
         jcboStoreName.addItem("QSR-Ahmedabad");
         jcboStoreName.addItem("QSR-BEL");
           jcboStoreName.addItem("QSR-Orion");
            jcboStoreName.addItem("QSR-RMZ");
            //   jcboStoreName.addItem("WMC- Brewpub");
      //  jcboStoreName.addItem("WMC- Terrace");
        // Printer 1
    ...
    public void loadProperties(AppConfig config) {
        ...
        jTxtPosNo.setText(config.getProperty("machine.PosNo"));
        jcboStoreName.setSelectedItem(config.getProperty("machine.StoreName"));
        jTxtvalidity.setText(config.getProperty("machine.Validity"));
  jchkTallyExport.setSelected(Boolean.valueOf(config.getProperty("payment.tallyexport")).booleanValue());
...
jcboLAF.setSelectedItem(new LunaLookAndFeel());
...
jcboSystemType.setSelectedItem(config.getProperty("machine.systemtype"));
    ...
    public void saveProperties(AppConfig config) {
        config.setProperty("machine.PosNo", jTxtPosNo.getText());
        config.setProperty("machine.hostname", jtxtMachineHostname.getText());
        config.setProperty("machine.StoreName", comboValue(jcboStoreName.getSelectedItem()));
        config.setProperty("machine.Validity", jTxtvalidity.getText());
        config.setProperty("payment.tallyexport", Boolean.toString(jchkTallyExport.isSelected()));
        ...
        config.setProperty("machine.ticketsbag", comboValue(jcboTicketsBag.getSelectedItem()));
         config.setProperty("machine.systemtype", comboValue(jcboSystemType.getSelectedItem()));
    ...
    private void initComponents() {
        ...
        jTxtPosNo = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        jTxtvalidity = new javax.swing.JTextField();
        jLabel9 = new javax.swing.JLabel();
        jcboSystemType = new javax.swing.JComboBox();
        jchkTallyExport = new javax.swing.JCheckBox();
        jcboStoreName = new javax.swing.JComboBox();
        ...
        jLabel3.setText("POS No.");

        jLabel4.setText("Store Name");

        jLabel8.setText("CreditNote Validity(in days)");

        jLabel9.setText("System Type");

        jcboSystemType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcboSystemTypeActionPerformed(evt);
            }
        });

        jchkTallyExport.setText("Tally Export is Applicable");
                    ...
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel13Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jcboSystemType, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel13Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanel13Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(jTxtvalidity, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                                            .addComponent(jTxtPosNo, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                                            .addComponent(jcboStoreName, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                        .addGap(34, 34, 34))
                                    .addGroup(jPanel13Layout.createSequentialGroup()
                                        .addComponent(jchkTallyExport, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(65, 65, 65)))))
        ...
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        .addComponent(jTxtPosNo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jcboStoreName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTxtvalidity, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jchkTallyExport, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jcboSystemType, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jcboSystemTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcboSystemTypeActionPerformed
        // TODO add your handling code here:
}//GEN-LAST:event_jcboSystemTypeActionPerformed
    ...
    private javax.swing.JTextField jTxtPosNo;
    ...
    private javax.swing.JComboBox jcboStoreName;
    private javax.swing.JComboBox jcboSystemType;
    private javax.swing.JComboBox jcboTicketsBag;
    private javax.swing.JCheckBox jchkTallyExport;
