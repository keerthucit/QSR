...
public class CategoriesEditor extends JPanel implements EditorRecord {
    ...
    public CategoriesEditor(AppView app, DirtyManager dirty) {
        ...
        initComponents();
        m_jCatalogAdd.setVisible(false);
        m_jCatalogDelete.setVisible(false);
       ...
       jCheckDiscountApplicable.addActionListener(dirty);
    ...
    public void writeValueEOF() {
        ...
        jCheckDiscountApplicable.setSelected(false);
        m_CategoryModel.setSelectedKey(null);
        m_jImage.setImage(null);
        m_jName.setEnabled(false);
        jCheckDiscountApplicable.setEnabled(false);
    ...
    public void writeValueInsert() {
        ...
        jCheckDiscountApplicable.setEnabled(true);
    ...
    public void writeValueEdit(Object value) {
        ...
        m_jImage.setImage((BufferedImage) cat[3]);
        if(cat[4].equals("Y"))
          jCheckDiscountApplicable.setSelected(true);
        else
           jCheckDiscountApplicable.setSelected(false);
    ...
    public Object createValue() throws BasicException {
        ...
        if(jCheckDiscountApplicable.isSelected()==true)
          cat[4] = "Y";
        else
          cat[4]="N";
        return cat;
    ...
    private void initComponents() {
        ...
        jCheckDiscountApplicable = new javax.swing.JCheckBox();
        ...
        add(m_jCatalogAdd);
        m_jCatalogAdd.setBounds(450, 20, 170, 30);
        ...
        m_jCatalogDelete.setBounds(450, 50, 170, 30);

        jLabel5.setText(AppLocal.getIntString("label.prodcategory")); // NOI18N
        add(jLabel5);
        jLabel5.setBounds(20, 50, 90, 18);
        add(m_jCategory);
        m_jCategory.setBounds(200, 50, 180, 20);

        jCheckDiscountApplicable.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckDiscountApplicableActionPerformed(evt);
            }
        });
        add(jCheckDiscountApplicable);
        jCheckDiscountApplicable.setBounds(200, 270, 190, 24);

        jLabel1.setText("Is Discount Applicable");
        add(jLabel1);
        jLabel1.setBounds(20, 270, 150, 18);
    ...
    private void jCheckDiscountApplicableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckDiscountApplicableActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCheckDiscountApplicableActionPerformed
    
    
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JCheckBox jCheckDiscountApplicable;
