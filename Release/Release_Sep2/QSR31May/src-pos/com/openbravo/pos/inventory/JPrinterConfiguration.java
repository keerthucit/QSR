 ...
 * @author adrianromero
 */
public class JPrinterConfiguration extends JPanel implements JPanelView,BeanFactoryApp{
   ...
   private static final JSectionMapping RandomUtil = null;
    ...
    public void init(AppView app) throws BeanFactoryException{
     ...
     //   m_dlPurchase = (DataLogicSystem) m_App.getBean("com.openbravo.pos.forms.DataLogicSystem");
        ...
        try {
            ...
            Logger.getLogger(JPrinterConfiguration.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        m_jPrinter = new javax.swing.JList();
        ...
        m_jPrinter.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                m_jPrinterValueChanged(evt);
            }
        });
        jScrollPane1.setViewportView(m_jPrinter);
    ...
    private void m_jPrinterValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_m_jPrinterValueChanged
        // TODO add your handling code here:
        if (evt.getValueIsAdjusting()) {
            System.out.println("inside value changed -- list selection event fired");
            int index=m_jPrinter.getSelectedIndex();
            updateMode = true;
            String PAreaTypeName = null;
            try {
                PAreaTypeName = m_jPrinter.getSelectedValue().toString();
            } catch (Exception ex) {
    ...
    }//GEN-LAST:event_m_jPrinterValueChanged

    private void jbtnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnNewActionPerformed

        m_jSearchKey.setText("");
        m_jName.setText("");
        m_jPrinter.clearSelection();
        updateMode = false;
    ...
    private void jbtnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDeleteActionPerformed
        ...
        if (index == -1) {
            JOptionPane.showMessageDialog(JPrinterConfiguration.this, "Please select the Printer");
        } else {
            try {
                String val = m_jPrinter.getSelectedValue().toString();
                dlCustomers.deletePrinter(val);
                m_jSearchKey.setText("");
                m_jName.setText("");
                m_jDesc.setText("");
    ...
    private void jbtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSaveActionPerformed
        ...
        if (m_jSearchKey.getText().equals("") || m_jName.getText().equals("")) {
            JOptionPane.showMessageDialog(JPrinterConfiguration.this, "Please enter the Printer");
        } else {
            try {
                saveButtonAction();
            } catch (BasicException ex) {
 ...
 public void populateList() throws BasicException {
        ...
        m_jPrinter.setModel(model);
        list = dlCustomers.getPrinterConfigurationList();
        String[] dListId = null;
...
private void saveButtonAction() throws BasicException {
        ...
        if (name != null) {
           ...
           System.out.println("updatemode"+updateMode);
                if (updateMode == false) {
                    if (avl == false) {
                        dlCustomers.insertPrinter(RandomUtil.genRandom32Hex(),skey,name,desc);
                    } else {
                        JOptionPane.showMessageDialog(this, "Entered Printer already exists");
                    }
                } else {
                    String id = list.get(m_jPrinter.getSelectedIndex()).getId();
                    dlCustomers.updatePinter(id,skey,name,desc);
                    updateMode = false;
                }
                populateList();
                m_jSearchKey.setText("");
                ...
                m_jDesc.setText("");
                 ...
                 npe.printStackTrace();
                JOptionPane.showMessageDialog(this, "Enter valid Printer");
                m_jSearchKey.setText("");
                m_jName.setText("");
                m_jDesc.setText("");
             }
    ...
    private boolean checkPAreaTypeAvl(String pname) throws BasicException {
        String name = dlCustomers.getPrinterName(pname);
    ...
    private javax.swing.JList m_jPrinter;
