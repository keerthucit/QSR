...
public class ThumbNailBuilderPopularItems {
    ...
    public ThumbNailBuilderPopularItems(int width, int height) {
        init(width, height, null);
    }
    
    public ThumbNailBuilderPopularItems(int width, int height, Image imgdef) {
        init(width, height, imgdef);
      
    }
    
    public ThumbNailBuilderPopularItems(int width, int height, String img) {
    ...
    public Image getThumbNailText(Image img, String text) {
       ...
       Color c1 = new Color(0xff, 0xff, 0xff, 0x40);
        ...
        //Color c1 = new Color(69,83,155);
        //Color c2 = new Color(69,83,155);
